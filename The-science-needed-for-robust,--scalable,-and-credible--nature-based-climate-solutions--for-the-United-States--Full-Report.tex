...
\hypersetup{
  pdftitle={The science needed for robust, scalable, and credible nature-based climate solutions for the United States: Full Report},
  pdfauthor={Kim Novick (Indiana University); Christopher Williams (Clark University); Benjamin Runkle (University of Arkansas); William Anderegg (University of Utah); Dave Hollinger (USDA Forest Service); Marcy Litvak (University of New Mexico)},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, coltitle=black, rightrule=.15mm, leftrule=.75mm, breakable, titlerule=0mm, opacityback=0, toptitle=1mm, colback=white, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, arc=.35mm, toprule=.15mm, opacitybacktitle=0.6, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1: Elements of robust, scalable, and credible NbCS}, colbacktitle=quarto-callout-note-color!10!white, left=2mm]
